(function(root, factory) {
  ...
  return {
    ...
    collectActivity(context) {
      ...
      const rawTitle = context.metaTags["og:title"] || context.metaTags["twitter:title"] || context.document.title || "";
      ...
      return {
        ...
        activityCard: {
          ...
          startedAtUnixSeconds: playing ? timestamps.startedAtUnixSeconds : null,
          endAtUnixSeconds: playing ? timestamps.endAtUnixSeconds : null,
          assets: {
